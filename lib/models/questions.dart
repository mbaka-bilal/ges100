...
final List<Map<String, dynamic>> ges101 = [
  ...
  {
    'question': 'The movement of the cursor to the next line as it gets to the end of the margin in the document area is called',
    'options': 'cursor movement|word wrap|text wrap|enter new line|neither A, B, C nor D',
    'answer': 'word wrap',
    'answerIndex': 1
  },
  {
    'question': 'Multiple windows that are opened are indicated on the',
    'options': 'menu bar|standard tools bar|notification bar|task pane|task bar',
    'answer': 'task bar',
    'answerIndex': 4
  },
  {
    'question': 'A file in Microsoft office excel is saved as a',
    'options': 'spreadsheet|excel file doc.|workbook|spread sheet book|all of the above',
    'answer': 'workbook',
    'answerIndex': 2
  },
  {
  ...
  },
  {
    ...
    'options': 'Title bar|Menu bar|Standard toolbar|Formatting toolbar|page setup bar',
    'answer': 'page setup bar',
    'answerIndex': 4
  },
  {
    'question': 'The movement of full or part of document from one place to another leaving the original copy is called',
  ...
  {
    'question': 'The keyboard key that deletes all the characters in a buffer up to the last character is',
  ...
  {
    'question': 'Excel is an electronic spread sheet to calculate, analyze and view data',
  ...
  },
  {
    ...
    'options': 'press the tab key on the keyboard|use the mouse to select the next cell|use of any of the four arrows keys|none of the above|all of the above except d',
    'answer': 'all of the above except d',
    'answerIndex': 4
  },
  {
    'question': 'The Fill Handle is to',
    'options': 'fill data into a row or column|generate the sequence data in a row or column|a and b is correct|only a is correct|only b is correct',
    'answer': 'a and b is correct',
    'answerIndex': 2
  },
  {
    'question': 'Font, font style, double strike through, emboss, subscript and all cap are all check boxes in',
    'options': 'Edit|View|File|Menu|Format',
    'answer': 'Format',
    'answerIndex': 4
  },
  {
    'question': 'The file with the following extensions .DOC, .VBP, .XLS and. FOR are',
    'options': 'word document, visual basic program, excel and Fortran|word document, visual basic program, excel and Fortran|word document, visual basic package, excel and Fortran|all of the above|none of the above',
  ...
  },
  {
    ...
    'options': 'display s*.* is not an internal or external command|display an error message|display all dir and files that starts with letter s|display s*.* is a file|display s*.* does not exist',
    'answer': 'display all dir and files that starts with letter s',
    'answerIndex': 2
  },
  {
    'question': 'The cls command in DOS',
    'options': 'shutdown the computer|shutdown the system|display all directory with cls name|restart the program|clear the screen',
    'answer': 'clear the screen',
    'answerIndex': 4
  },
  {
    'question': 'Formatting in Microsoft excel and Microsoft word is the same method',
  ...
  },
  {
    ...
    'options': 'the data in an active cell|the cell that is selected|a and b is correct|only a is correct|only b is correct',
    'answer': 'a and b is correct',
    'answerIndex': 2
  },
  {
    'question': 'Ctrl + Z command will perform what function',
    'options': 'select all|copy all|Undo the last command|display all zip files|show zip folder',
    'answer': 'Undo the last command',
    'answerIndex': 2
  },
  {
    'question': 'Icons are',
    'options': 'short cuts to programs in the computer|picture commands|picture short cut of Microsoft package in a DOS command|pictorial representations of programs, applications and commands|only d and a are correct',
    'answer': 'pictorial representations of programs, applications and commands',
    'answerIndex': 3
  },
  {
    'question': 'The roller on a PS2 mouse enables the user to',
    'options': 'scroll up and down|saves 35% of the time spent scrolling a document|zoom in and out a graphic application|a, b and c is correct|only b and c is correct',
